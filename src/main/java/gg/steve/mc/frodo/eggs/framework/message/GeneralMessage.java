package gg.steve.mc.frodo.eggs.framework.message;

import gg.steve.mc.frodo.eggs.framework.utils.ColorUtil;
import gg.steve.mc.frodo.eggs.framework.actionbarapi.ActionBarAPI;
...
public enum GeneralMessage {
    RELOAD("reload"),
    HELP("help"),
    EGG_INFO("egg-info", "{id}", "{group}", "{world}", "{x}", "{y}", "{z}", "{total-found}", "{placer}"),
    EGG_TP("egg-tp", "{id}", "{world}", "{x}", "{y}", "{z}"),
    EGG_LIST("egg-list", "{group}", "{eggs}"),
    EGG_RECEIVE("egg-receive", "{group}");
